  ...
  return (
    <div className="min-h-screen bg-dashboard-bg">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">
                  Gráfico de População - Maturidade Digital
                </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        {/* Gráfico de População em Tela Cheia */}
        <div className="bg-card rounded-lg border border-border p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-muted-foreground">
              Análise da população atendida por cada microrregião
            </p>
          </div>
      ...
      <footer className="bg-dashboard-header border-t border-border mt-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="text-center text-sm text-muted-foreground">
            <p>Gráfico de População - Maturidade Digital • Análise demográfica regional</p>
          </div>
        </div>
      </footer>
    </div>
